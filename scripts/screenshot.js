...
const ROUTES = [
  ['/',                                                          'dashboard',              'Dashboard'],
  ['/areas',                                                     'areas',                  'Areas'],
  ['/history?entity_id=sensor.snzb_02_bedroom_temperature',      'history',                'History'],
  ['/logbook',                                                   'logbook',                'Logbook'],
  ['/devices',                                                   'devices',                'Devices'],
  ['/notifications',                                             'notifications',          'Notifications'],
  ['/zigbee',                                                    'zigbee-devices',         'Zigbee Devices'],
  ['/zigbee/0xec1bbdfffecafe01',                                 'zigbee-sensor-detail',   'Zigbee Sensor Detail'],
  ['/zigbee/0xec1bbdfffecafe01/entities/sensor.snzb_02_bedroom_temperature', 'zigbee-entity-edit',  'Zigbee Entity Edit'],
